...
public class BossShurikenScript : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        hpTextObj.GetComponent<TextMeshProUGUI>().text = "Samurai General HP: " + bossHP.ToString();
    }
    ...
    void OnCollisionEnter2D(Collision2D collision)
    {
        ...
        if (collision.gameObject.tag == "ExitGlory" && bossHP == 0)
        {
